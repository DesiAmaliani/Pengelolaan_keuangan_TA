            ...
            <div class="invoice">
              ...
              <div class="text-md-right">
                <div class="float-lg-left mb-lg-0 mb-3">
                  <a href="<?php echo site_url('client/pembayaran') ?>" button class="btn btn-danger btn-icon icon-left"><i class="fas fa-times"></i> Cancel</a>
                </div>
                <a href="<?php echo site_url('pembayaran_client/invoice_print/'.$id_pem);?>" button class="btn btn-warning btn-icon icon-left"><i class="fas fa-print"></i> Print</a>
              </div>
            </div>
          </div>
        </section>
