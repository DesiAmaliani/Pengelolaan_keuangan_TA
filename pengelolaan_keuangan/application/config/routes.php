...
$route['admin/jenis_paket'] = 'jenis_paket/index';
$route['admin/paket'] = 'paket/index';
$route['admin/data_bts'] = 'data_bts/index';
$route['admin/alat_dibts'] = 'alat_dibts/index';
$route['admin/info_ip_client'] = 'info_ip_client/index';
