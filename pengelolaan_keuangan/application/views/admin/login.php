        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="<?php echo site_url('login_admin/index') ?>" class="needs-validation" novalidate="">
            ...
            <div class="mt-5 text-muted text-center">
              Tidak Punya Akun? <a href="<?php echo site_url() ?>register">Daftar Sekarang</a>
            </div>
