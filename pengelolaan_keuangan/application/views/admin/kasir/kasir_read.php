              ...
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  ...
                  <div class="table-responsive">
                    ...
                    <tr><td><b>Foto</b></td><td><img src="<?php echo base_url(); ?>tampilan/profil/<?php echo $foto ?>" alt="logo" width="80" class="shadow-light rounded-circle"></td></tr>
                    <tr><td></td><td><a href="<?php echo site_url('admin/kasir') ?>" class="btn btn-default">Cancel</a></td></tr>
                </table>
                </div>
                </div>
          </div>
