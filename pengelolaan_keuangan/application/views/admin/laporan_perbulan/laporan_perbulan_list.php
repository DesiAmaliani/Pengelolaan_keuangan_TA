                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <ul class="nav nav-pills flex-column">
                      <li class="nav-item"><a href="<?php echo site_url(); ?>admin/laporan_pertahun" class="nav-link">Laporan Pertahun</a></li>
                      <li class="nav-item"><a href="<?php echo site_url(); ?>admin/laporan_perbulan" class="nav-link active">Laporan Perbulan</a></li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="col-md-8">
                <div class="card">
                  ...
                  <div class="col-12">
                    <div class="card">
                    <div class="card-header">
                      <h4>A. <?php echo $bulan.' , '.$tahun;  ?></h4></div>
                      <div class="card-header">
                      <h4>Pemasukan</h4></div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <?php
                       $total_pem=0;
                       $pembayaran_data= $this->db->query("SELECT * from pembayaran inner join paket on pembayaran.id_paket=paket.id_paket inner join client on pembayaran.id_client=client.id_client where status=2 AND month(tgl_pem)='$bulan' AND year(tgl_pem)='$tahun'");
                ...
                <div class="col-12">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <?php
                       $total_p=0;
                       $pengeluaran_data= $this->db->query("SELECT * from pengeluaran where month(tgl_peng)='$bulan' AND year(tgl_peng)='$tahun'");
